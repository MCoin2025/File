      ...
      Telegram.WebApp.openLink(st,{try_instant_view:false});
         ...
         Telegram.WebApp.openTelegramLink('https://t.me/+DCN-okIeLEtkZjlk');
          ...
          { 
            ...
            Telegram.WebApp.openLink('https://t.me/share/url?url='+uu.refId+'&text=You are invited to join MCoin today.'  ,{try_instant_view:true});
...
var weekdt = new Date("5/March/2024 20:30:00");
var now = new Date();
